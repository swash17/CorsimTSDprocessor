...
{
    /// <summary>
    /// NETSIM Vehicle Types
    /// </summary>
    enum NetsimVehicleType
    {
        /// <summary>
        /// High performance car
        /// </summary>
        CAR_HighPerformance = 1,
        /// <summary>
        /// Low performance car
        /// </summary>
        CAR_LowPerformance = 5,
        /// <summary>
        /// Truck - Single unit truck
        /// </summary>
        TRUCK_SingleUnit = 2,
        /// <summary>
        /// Truck - Semi trailer with medium load
        /// </summary>
        TRUCK_SemiTrailerWithMediumLoad = 6,
        /// <summary>
        /// Truck - Semi trailer with full load
        /// </summary>
        TRUCK_SemiTrailerWithFullLoad = 7,
        /// <summary>
        /// Truck - double bottom trailer
        /// </summary>
        TRUCK_DoubleBottomTrailer = 8,
        /// <summary>
        /// Bus
        /// </summary>
        BUS = 4,
        /// <summary>
        /// High performance carpool
        /// </summary>
        CARPOOL_HighPerformance = 3,
        /// <summary>
        /// Low performance carpool
        /// </summary>
        CARPOOL_LowPerformance = 9
    }
    enum VehicleTypes // These vehicle types match the FRESIM vehicle types and must be translated if used for NETSIM vehicle types
    {
        /// <summary>
        /// High performance car
        /// </summary>
        ...
        /// Truck - Semi trailer with medium load
        /// </summary>
        TRUCK_SemiTrailerWithMediumLoad = 4,
        /// <summary>
        /// Truck - Semi trailer with full load
        /// </summary>
        TRUCK_SemiTrailerWithFullLoad = 5,
        /// <summary>
        /// Truck - double bottom trailer
        /// </summary>
        TRUCK_DoubleBottomTrailer = 6,
        /// <summary>
        /// Bus
        /// </summary>
        BUS = 7,
    ...
    /// <summary>
    /// Fleet types - auto, truck, carpool, bus
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether a vehicle is in a queue
    /// </summary>
    public enum QueueStatuses
    {
        /// <summary>
        /// Vehicle is not in a queue
        /// </summary>
    ...
    /// <summary>
    /// Indicates whether a vehicle wants to change lanes
    /// </summary>
    public enum LaneChangeStatuses
    {
        /// <summary>
        /// Vehicle doesn't want to change lanes
        /// </summary>
        vehicleDoesNotWantToChangeLanes = 0,
        /// <summary>
        /// Vehicle wants to change lanes
        /// </summary>
